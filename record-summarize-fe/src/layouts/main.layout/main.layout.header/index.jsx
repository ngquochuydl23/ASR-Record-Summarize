...
import { Avatar, Badge, Box, Divider, IconButton, ListItemIcon, ListItemText, MenuItem, MenuList, Popover, styled, Typography } from "@mui/material";
              ...
              <div className="inside-popover">
                <ul className="menu-list">
                  <li className="menu-list-item">
                    <Link to={AppRoute.PERSONAL_INFO} onClick={handleClose}>{`Thông tin cá nhân`}</Link>
                  </li>
                  <li className="menu-list-item">
                    <a>{`Đổi mật khẩu`}</a>
                  </li>
