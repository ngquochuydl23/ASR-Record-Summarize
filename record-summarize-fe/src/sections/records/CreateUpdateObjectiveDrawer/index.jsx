...
import './styles.scss';
import IcKeyResultHeader from "@/assets/icons/IcKeyResultHeader";
              ...
              <div className="flex flex-col">
                <div className="flex flex-col gap-2 mt-4">
                  ...
                  <FormControl variant="standard" fullWidth >
                    <InputLabel shrink htmlFor="parentId" size="small">Owner</InputLabel>
                  ...
                  <FormControl variant="standard" fullWidth >
                    <InputLabel shrink htmlFor="parentId" size="small">Chia sẻ với mọi người</InputLabel>
                    <BootstrapAutocomplete
                      // id="parentId"
                      // name="parentId"
                      multiple
                ...
                <h5 className="font-[600] w-full mt-4">Tải lên video</h5>
